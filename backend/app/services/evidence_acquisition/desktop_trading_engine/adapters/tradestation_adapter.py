...
class TradeStationAdapter(BaseDesktopAdapter):
    """
    Thin adapter for TradeStation Desktop.
    ...
    def acquire(self) -> Dict[str, Any]:
        """
        Acquire the complete TradeStation native evidence
        surface.
