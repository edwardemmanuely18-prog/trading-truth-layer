...
class QuantowerAdapter(BaseDesktopAdapter):
    """
    Thin adapter for Quantower Desktop.

    Quantower exposes trading functionality through
    its native SDK and connector architecture. TTL
    communicates through an external bridge supplied
    to this adapter.
    ...
    def connect(self) -> None:
        """
        Connect to the Quantower bridge.
        """
    ...
    def disconnect(self) -> None:
        """
        Disconnect from the Quantower bridge.
        """
    ...
    def is_connected(self) -> bool:
        """
        Determine whether the Quantower bridge
        is connected.
        """
    ...
    def acquire(self) -> Dict[str, Any]:
        """
        Acquire the complete Quantower native evidence
        surface.
