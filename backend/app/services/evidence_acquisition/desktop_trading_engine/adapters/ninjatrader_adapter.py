...
class NinjaTraderAdapter(BaseDesktopAdapter):
    """
    Thin adapter for NinjaTrader Desktop.

    NinjaTrader exposes its trading functionality through
    its native API. TTL communicates with NinjaTrader
    through an external bridge supplied to this adapter.
    ...
    def is_connected(self) -> bool:
        """
        Determine whether the NinjaTrader bridge
        is connected.
        """
    ...
    def acquire(self) -> Dict[str, Any]:
        """
        Acquire the complete NinjaTrader native evidence
        surface.
