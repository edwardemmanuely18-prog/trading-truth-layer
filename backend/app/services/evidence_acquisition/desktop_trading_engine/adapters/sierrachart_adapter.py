...
class SierraChartAdapter(BaseDesktopAdapter):
    """
    Thin adapter for Sierra Chart Desktop.

    Sierra Chart exposes trading functionality through
    its native interfaces (ACSIL / DTC Protocol). TTL
    communicates through an external bridge supplied to
    this adapter.
    ...
    def connect(self) -> None:
        """
        Connect to the Sierra Chart bridge.
        """
    ...
    def disconnect(self) -> None:
        """
        Disconnect from the Sierra Chart bridge.
        """
    ...
    def is_connected(self) -> bool:
        """
        Determine whether the Sierra Chart bridge
        is connected.
        """
    ...
    def acquire(self) -> Dict[str, Any]:
        """
        Acquire the complete Sierra Chart native evidence
        surface.
