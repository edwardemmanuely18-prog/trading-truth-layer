...
class MultiChartsAdapter(BaseDesktopAdapter):
    """
    Thin adapter for MultiCharts Desktop.

    MultiCharts exposes its trading functionality through
    its native platform APIs. TTL communicates through an
    external bridge supplied to this adapter.
    ...
    def connect(self) -> None:
        """
        Connect to the MultiCharts bridge.
        """
    ...
    def disconnect(self) -> None:
        """
        Disconnect from the MultiCharts bridge.
        """
    ...
    def is_connected(self) -> bool:
        """
        Determine whether the MultiCharts bridge
        is connected.
        """
    ...
    def acquire(self) -> Dict[str, Any]:
        """
        Acquire the complete MultiCharts native evidence
        surface.
