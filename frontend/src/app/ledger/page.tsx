      ...
      <main className="mx-auto max-w-[1400px] px-6 py-10">
          ...
          <div className="mb-4 flex items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Most recent governance and lifecycle actions across the platform.
              </p>
            </div>
          </div>
        ...
        <div className="mb-8 rounded-2xl border bg-white p-5 shadow-sm">
          <div className="mb-4 flex items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Detailed audit trail for workspace 1, including state transitions and metadata.
              </p>
            </div>
          </div>

          {workspaceAuditEvents.length === 0 ? (
            <div className="text-sm text-slate-500">No workspace audit events found.</div>
          ) : (
            <div className="overflow-x-auto">
              <table className="min-w-full text-sm">
                <thead>
        ...
        <div className="rounded-2xl border bg-white p-5 shadow-sm">
          <div className="mb-4">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Canonical normalized trades currently stored in the workspace ledger.
            </p>
          </div>
