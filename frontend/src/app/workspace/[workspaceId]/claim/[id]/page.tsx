...
export default function WorkspaceClaimDetailPage() {
  ...
  const loadClaimPage = async () => {
    ...
    try {
      const [claimRes, previewRes, versionsRes, auditRes, equityRes, tradesRes] = await Promise.all([
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main className="space-y-6 p-6">
        ...
        {equityCurve && <EquityCurveChart title="Internal Equity Curve" points={equityCurve.curve} />}
